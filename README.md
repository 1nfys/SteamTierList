...
*   **Примечание:** Файл вида `google...html` нужен только для подтверждения прав на оригинальный домен в поисковых системах. При разворачивании собственного форка качать его и переносить к себе не нужно.
...
*   **Note:** A file like `google...html` is solely for search engine domain verification of the original site. You don't need to download or include it if you are deploying your own fork.
